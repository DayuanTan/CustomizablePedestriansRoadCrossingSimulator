...
def param_input(root, params):
    ...
    params.crosswalk_width_entry = tk.Entry(frame, width=5)
    params.crosswalk_width_entry.insert(0, params.crosswalk_width)
    params.crosswalk_width_entry.place(relx=0.85, rely=0.2, anchor="w")
    ...
    params.crosswalk_length_entry = tk.Entry(frame, width=5)
    params.crosswalk_length_entry.insert(0, params.crosswalk_length)
    params.crosswalk_length_entry.place(relx=0.85, rely=0.27, anchor="w")
    ...
    params.ped_amount_lr_entry = tk.Entry(frame, width=5)
    params.ped_amount_lr_entry.insert(0, params.ped_amount_lr)
    params.ped_amount_lr_entry.place(relx=0.85, rely=0.34, anchor="w")
    ...
    params.ped_amount_rl_entry = tk.Entry(frame, width=5)
    params.ped_amount_rl_entry.insert(0, params.ped_amount_rl)
    params.ped_amount_rl_entry.place(relx=0.85, rely=0.41, anchor="w")
    ...
    params.wheelchair_amount_lr_entry = tk.Entry(frame, width=5)
    params.wheelchair_amount_lr_entry.insert(0, params.wheelchair_amount_lr)
    params.wheelchair_amount_lr_entry.place(relx=0.85, rely=0.48, anchor="w")
    ...
    params.wheelchair_amount_rl_entry = tk.Entry(frame, width=5)
    params.wheelchair_amount_rl_entry.insert(0, params.wheelchair_amount_rl)
    params.wheelchair_amount_rl_entry.place(relx=0.85, rely=0.55, anchor="w")
    ...
    params.crutches_user_amount_lr_entry = tk.Entry(frame, width=5)
    params.crutches_user_amount_lr_entry.insert(0, params.crutches_user_amount_lr)
    params.crutches_user_amount_lr_entry.place(relx=0.85, rely=0.62, anchor="w")
    ...
    params.crutches_user_amount_rl_entry = tk.Entry(frame, width=5)
    params.crutches_user_amount_rl_entry.insert(0, params.crutches_user_amount_rl)
    params.crutches_user_amount_rl_entry.place(relx=0.85, rely=0.69, anchor="w")
    ...
    params.children_amount_lr_entry = tk.Entry(frame, width=5)
    params.children_amount_lr_entry.insert(0, params.children_amount_lr)
    params.children_amount_lr_entry.place(relx=0.85, rely=0.76, anchor="w")
    ...
    params.children_amount_rl_entry = tk.Entry(frame, width=5)
    params.children_amount_rl_entry.insert(0, params.children_amount_rl)
    params.children_amount_rl_entry.place(relx=0.85, rely=0.83, anchor="w")
    ...
    params.elder_amount_lr_entry = tk.Entry(frame, width=5)
    params.elder_amount_lr_entry.insert(0, params.elder_amount_lr)
    params.elder_amount_lr_entry.place(relx=0.85, rely=0.9, anchor="w")
    ...
    params.elder_amount_rl_entry = tk.Entry(frame, width=5)
    params.elder_amount_rl_entry.insert(0, params.elder_amount_rl)
    params.elder_amount_rl_entry.place(relx=0.85, rely=0.97, anchor="w")
    ...
    params.step_time_entry = tk.Entry(right_frame, width=5)
    ...
    params.waiting_area_length_entry = tk.Entry(right_frame, width=5)
    ...
    params.ped_walking_speed_min_entry = tk.Entry(right_frame, width=5)
    ...
    params.ped_walking_speed_max_entry = tk.Entry(right_frame, width=5)
    ...
    params.ped_walking_speed_mean_entry = tk.Entry(right_frame, width=5)
    ...
    params.wheelchair_rolling_speed_min_entry = tk.Entry(right_frame, width=5)
    ...
    params.wheelchair_rolling_speed_max_entry = tk.Entry(right_frame, width=5)
    ...
    params.wheelchair_rolling_speed_mean_entry = tk.Entry(right_frame, width=5)
    ...
    params.crutches_user_walking_speed_min_entry = tk.Entry(right_frame, width=5)
    ...
    params.crutches_user_walking_speed_max_entry = tk.Entry(right_frame, width=5)
    ...
    params.crutches_user_walking_speed_mean_entry = tk.Entry(right_frame, width=5)
    ...
    params.children_walking_speed_min_entry = tk.Entry(right_frame, width=5)
    ...
    params.children_walking_speed_max_entry = tk.Entry(right_frame, width=5)
    ...
    params.children_walking_speed_mean_entry = tk.Entry(right_frame, width=5)
    ...
    params.elder_walking_speed_min_entry = tk.Entry(right_frame, width=5)
    ...
    params.elder_walking_speed_max_entry = tk.Entry(right_frame, width=5)
    ...
    params.elder_walking_speed_mean_entry = tk.Entry(right_frame, width=5)
    ...
    distribution_type_label = tk.Label(right_frame, text="Choose one distribution type:")
    distribution_type_label.place(relx=0.5, rely=0.62, anchor="w")
    params.distribution_type_entry = tk.Entry(right_frame, width=5)
    params.distribution_type_entry.insert(0, params.distribution_type)
    params.distribution_type_entry.place(relx=0.9, rely=0.62, anchor="w")
    
    distribution_type_label2 = tk.Label(right_frame, text="You MUST input 1 or 2 or 3.")
    distribution_type_label2.place(relx=0.5, rely=0.65, anchor="w")
    distribution_type_label3 = tk.Label(right_frame, text="1 for normal distributin (defulat, recommended); ")
    distribution_type_label3.place(relx=0.5, rely=0.68, anchor="w")
    distribution_type_label4 = tk.Label(right_frame, text="2 for poisson distribution; ")
    distribution_type_label4.place(relx=0.5, rely=0.71, anchor="w")
    distribution_type_label5 = tk.Label(right_frame, text="3 for student t distribution.")
    distribution_type_label5.place(relx=0.5, rely=0.74, anchor="w")
...
def param_save_button_logic(root, params):
    try:
        # basic
        params.crosswalk_width = float(params.crosswalk_width_entry.get())
        params.crosswalk_length = float(params.crosswalk_length_entry.get())
        ...
        # adv
        params.step_time = float(params.step_time_entry.get())
        params.waiting_area_length = float(params.waiting_area_length_entry.get())
        params.ped_walking_speed_min = float(params.ped_walking_speed_min_entry.get())
        params.ped_walking_speed_max = float(params.ped_walking_speed_max_entry.get())
        params.ped_walking_speed_mean = float(params.ped_walking_speed_mean_entry.get())
        params.wheelchair_rolling_speed_min = float(params.wheelchair_rolling_speed_min_entry.get())
        params.wheelchair_rolling_speed_max = float(params.wheelchair_rolling_speed_max_entry.get())
        params.wheelchair_rolling_speed_mean = float(params.wheelchair_rolling_speed_mean_entry.get())
        params.crutches_user_walking_speed_min = float(params.crutches_user_walking_speed_min_entry.get())
        params.crutches_user_walking_speed_max = float(params.crutches_user_walking_speed_max_entry.get())
        params.crutches_user_walking_speed_mean = float(params.crutches_user_walking_speed_mean_entry.get())
        params.children_walking_speed_min = float(params.children_walking_speed_min_entry.get())
        params.children_walking_speed_max = float(params.children_walking_speed_max_entry.get())
        params.children_walking_speed_mean = float(params.children_walking_speed_mean_entry.get())
        params.elder_walking_speed_min = float(params.elder_walking_speed_min_entry.get())
        params.elder_walking_speed_max = float(params.elder_walking_speed_max_entry.get())
        params.elder_walking_speed_mean = float(params.elder_walking_speed_mean_entry.get())
        params.distribution_type = int(params.distribution_type_entry.get())
        ...
        print(e)
        print("Invalid arguments! Please restart.")
        sys.exit(1)
        ...
        if params.crosswalk_width <= 0 or params.crosswalk_length <= 0 or params.ped_amount_lr <= 0 or params.ped_amount_rl <= 0 \
            ...
            # messagebox.showinfo(title="Alert", message="Invalid arguments! Invalid range!")
            
            # # params = global_params.global_params()
            # # param_input(root, params)
            # param_save_button_func(root, params)
            print("Invalid argument range! Please restart.")
            sys.exit(1)
        elif params.distribution_type not in [1, 2, 3]:
            # messagebox.showinfo(title="Alert", message="Wrong distribution_type argument! You must input 1 or 2 or 3!")
            # params = global_params.global_params()
            # param_input(root, params)
            # param_save_button_func(root, params)
            print("Wrong distribution_type argument! You must input 1 or 2 or 3!! Please restart.")
            sys.exit(1)
            ...
            messagebox.showinfo(title="Parameters applied", message="Parameters applied! \nBasic parameters:" 
                ...
                + "\ndistribution_type: " + str(params.distribution_type) 
                )
