class global_params:
    def __init__(self):
        ...
        self.crosswalk_width = 1 #cm
        self.crosswalk_length = 1 #cm
        ...
        self.ped_amount_lr = 1
        self.ped_amount_rl = 1
        ...
        self.ped_walking_speed_mean = 126.76 #cm/s
        ...
        self.ped_walking_speed_sigma = 9.167
