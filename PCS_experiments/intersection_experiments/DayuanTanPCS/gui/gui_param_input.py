...
def param_save_button_logic(root, params):
    ...
    params.ped_walking_speed_min_entry = float(params.ped_walking_speed_min_entry.get())
    params.ped_walking_speed_max_entry = float(params.ped_walking_speed_max_entry.get())
    params.ped_walking_speed_mean_entry = float(params.ped_walking_speed_mean_entry.get())
