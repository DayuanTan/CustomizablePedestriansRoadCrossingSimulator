...
import gui.gui_param_input as gui_param_input
import gui.gui_crossing_window as cross

root = tk.Tk()
root.title('Pedestrian Crossing Street Simulation')
root.geometry("1600x800")

# top greeting section
greeting = tk.Label(root, text="Pedestrian Crossing Street Simulation by Dayuan Tan @UMBC")
...
# param input section
gui_param_input.param_input(root, params)

# buttons
save_button = tk.Button(params.frame, text="Save parameters", command = lambda: gui_param_input.param_save_button_func(root, params) )
